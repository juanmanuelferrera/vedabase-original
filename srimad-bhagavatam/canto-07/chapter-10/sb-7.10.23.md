...
"Whatever action a great man performs, common men follow. And whatever standards he sets by exemplary acts, all the world pursues." [[bg/3/21|(Bg. 3.21)]] One should not be attached to any materialistic activities, but a devotee may perform such activities as an example to show the common man that one should not deviate from the Vedic injunctions.
