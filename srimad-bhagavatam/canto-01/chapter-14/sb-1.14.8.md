...
As we have discussed many times, the Supreme Personality of Godhead Lord Śrī Kṛṣṇa has many plenary expansions, and each and every one of them, although equally powerful, executes different functions. In the Bhagavad-gītā there are different statements by the Lord, and each of these statements is meant for different plenary portions or portions of the plenary portions. For example, Śrī Kṛṣṇa the Lord says in the Bhagavad-gītā:
