# Room Conversation with Prof. Regamay

*Type: Conversation Dated: June 4th 1974 Location: Geneva Audio file: 740604R1.GEN.mp3*
...
Prabhupāda: This is very good example. There are many candles. Just like you ignite one candle, then from this candle another candle, another candle. There many thousands of candles. So each candle is of the same power, lighting power. But still, the first one is called original. So far the candlepower is concerned, they are of equal flame, but still, the first candle, the second candle, the third candle, like that.
