...
*Type: Conversation Dated: May 29th 1977 Location: Vṛndāvana Audio file: 770529R1.VRN.mp3*
...
Gargamuni: Well, we only printed two Oriya books. Both were printed in Calcutta so far, because there's one Oriya printer there. Gaura-Govinda Mahārāja is investigating completely the... We went around investigating the presses in Cuttack and Bhubaneswar, if we might get some cheaper or easier price. It appears that some things we can do cheaper there, like the inside part, but cover cannot do cheaper there.
