...
A naturalist can see the general course of material nature simply by studying a piece of fruit. A small fruit develops from a flower, grows, stays for some time and then it becomes full grown and ripen, then begins to dwindle daily until it finally falls from the tree and commences to decompose into the earth and at last mingles with the earth, leaving behind its seed which in its turn grows to become a tree and produces many fruits in time, which will all meet the same fate, and so on and so on.
